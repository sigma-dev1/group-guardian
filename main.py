...
# Lista dei prefissi VoIP da bannare, inclusi +39 per testare
...
def check_phone(client, message):
    ...
    # Verifica se il numero ha un prefisso VoIP
    elif any(user_phone.startswith(prefix) for prefix in voip_prefixes):
