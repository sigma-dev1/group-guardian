    ...
    if message.from_user.id == OWNER_ID or message.from_user.username == OWNER_USERNAME:
        if len(message.command) > 1:
            ...
            if "mod" in message.command:
                ...
                await message.reply(f"{user.first_name} has been promoted to moderator in this group!")
            else:
        ...
        await message.reply("Only the bot owner can promote helpers or moderators.")
